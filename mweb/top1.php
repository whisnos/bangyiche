...
<div class="tl2">
	<div class="main">
    	...
    	<div class="r"><span>联系电话：</span><?php $teltop=$DB->Sels("lr","a_dy","id=13","","");echo FF($teltop[0],0);?></div>
    </div>
</div>
	<div class="td24">
    	<div class="main">
    ...
    <div class="tb20">
    	<div class="bd">
        	<ul>
			<?php
            $fz=$DB->Sel("pic","a_adv","lid=1","","3");
             while($R = SZ($fz)){
                  $img=CF($R['pic'],",");	  
                  echo '<li _src="url('.$img[1].')" style="background:#fff center 0 no-repeat;"></li>'.PHP_EOL;
              }?>                       
       		</ul>
        </div>
    	<div class="hd">
