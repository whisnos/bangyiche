...
class Utils_Caption
{
	...
	var $TFonts = array("0.ttf","1.ttf","2.ttf","3.ttf","4.ttf");
	var $TFontSize=array(14,18); //字体大小范围
	var $TFontAngle=array(-10,10); //旋转角度

	var $Chars   = "0123456789ABCDEFGHJKLMNPQRSTUVWXYZ";         //验证码范围（字母数字）

	var $Code    = array();              //验证码
	var $Image   = "";              //图形对象
	var $FontColors=array('#8ABF26','#1C7E9B','#3C4145');  //字体颜色,红绿蓝
	...
	public  function RandRSI() ///生成验证码
	{
		...
		$code="";
		$font=dirname(__FILE__)."/".$this->TFonts[rand(0,count($this->TFonts)-1)];
